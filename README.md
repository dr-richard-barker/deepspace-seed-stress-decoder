...
| Tool | What it does |
|---|---|
| **DSRS** — DeepSpace Stress-Recognition System | Given a transcriptomic signature, recognize **which space stressor** it most resembles (gravity, radiation, low-oxygen, magnetic/NMF, tropism, desiccation, osmotic, ethylene, temperature, UV). |
...
## Headline result
Across a **27-contrast / 10-family** deep-space stress model projected onto a 122-panel single-cell seed
reference (Gehring developmental + Liew/Lewsey germination atlases), the **radicle / root apical tip is the
...
scripts/       numbered, reproducible pipeline (01–26)
